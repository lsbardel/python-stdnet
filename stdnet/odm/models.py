...
from stdnet.utils import EMPTYJSON, JSPLITTER, iteritems, zip
from stdnet.utils.exceptions import *

from .base import ModelBase, ModelType, raise_kwargs
...
def create_model(name, *attributes, **params):
    ...
    kwargs = {"manager_class": params.pop("manager_class", Manager), "Meta": params}
