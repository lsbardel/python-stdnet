...
class StructureFieldProxy(LazyProxy):
    ...
    def get_structure(self, instance, session):
        ...
        if not self.field.class_field:
            ...
            if pkvalue is None:
                raise StructureFieldError(
                    'Cannot access "%s". The "%s" model '
...
class StructureField(Field):
    ...
    **Additional Field attributes**
    ...
    def __init__(
        self, model=None, pickler=None, value_pickler=None, class_field=False, **kwargs
    ):
    ...
    def _register_with_model(self):
        ...
        self.value_pickler = self.value_pickler or data_structure_class.value_pickler
        self.pickler = (
            self.pickler or data_structure_class.pickler or self.default_pickler
        )
        ...
        setattr(self.model, self.name, StructureFieldProxy(self, data_structure_class))
