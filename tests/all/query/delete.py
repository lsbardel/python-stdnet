...
from examples.data import FinanceTest, finance_data
from examples.models import Dictionary, Fund, Instrument, Position, SimpleModel
...
class update_model(object):
    ...
    def __call__(
        self, signal, sender, instances=None, session=None, transaction=None, **kwargs
    ):
