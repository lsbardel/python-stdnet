...
class TestManager(test.TestCase):
    ...
    def test_get_error(self):
        ...
        yield self.async.assertRaises(
            SimpleModel.DoesNotExist, objects.get, code="test3"
        )
        yield self.async.assertRaises(SimpleModel.DoesNotExist, objects.get, id=-400)
    ...
    def testIndexFilter(self):
        ...
        yield self.async.assertRaises(SimpleModel.DoesNotExist, objects.get, group="g1")
        ...
        yield self.async.assertRaises(stdnet.QuerySetError, objects.get, group="g2")
