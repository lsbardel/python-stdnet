...
class TestStdnetBranchCommand(TestCase):
    ...
    def test_zdiffstore_stdnet(self):
        self._zdiffstore()
        
    def test_zdiffstore(self):
        self._zdiffstore(using='vanilla')
        
    def test_zdiffstore_withscores_stdnet(self):
        self._zdiffstore_withscores()
